...
const char P3[]= "/io.cgi?led=2 ";
const char P4[]= "/io.cgi?led=3 ";
const char P5[]= "/tost";
const unsigned int L1[]= {15,16,14,14};
...
const int AnalogRefresh  = 2000;
unsigned long AnalogWeb = 0;
const unsigned long AnalogWebRefresh=600000;
...
const char serverOra[] = "www.mdmecco.it";
...
//bool PoBool[]={false,false,false,false};
// PoBool: 
// DayTimeT



  if (!bitRead(VBool,12) && (DayTimeT > POApertura) && (DayTimeT < POChiusura)){
    bitSet(VBool,12);
    bitSet(VBool,13);
